...
TOKEN = os.getenv("BOT_TOKEN", "8898297550:AAGfbEbfAgyZtNIix1TaycOqMmb2lWREjqQ")
...
def main():
    ...
    # Changed route to match your Render webhook url exactly
    app.router.add_post("/webhook_sms", handle_herosms_webhook)
    ...
    if WEBHOOK_URL:
        ...
        async def start_polling_and_server():
            ...
            await site.start()
            logging.info(f"Web server running on port {PORT} (HeroSMS Webhook active on /webhook_sms)")
